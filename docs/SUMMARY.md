...
* [_header](_header.md)
* [_platform_user_agent](_platform_user_agent.md)
* [_time_in_range](_time_in_range.md)
* [_validate_sql_db](_validate_sql_db.md)
* [_validate_sql_recovery_point](_validate_sql_recovery_point.md)
