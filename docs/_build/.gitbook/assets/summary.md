...
* [add_floating_ips](add_floating_ips.md)
* [add_guest_credential](add_guest_credential.md)
* [add_vcenter](add_vcenter.md)
* [cluster_node_id](cluster_node_id.md)
* [cluster_node_ip](cluster_node_ip.md)
* [cluster_node_name](cluster_node_name.md)
* [cluster_support_tunnel](cluster_support_tunnel.md)
* [cluster_version](cluster_version.md)
* [configure_cluster_location](configure_cluster_location.md)
* [configure_dns_servers](configure_dns_servers.md)
* [configure_login_banner](configure_login_banner.md)
* [configure_ntp](configure_ntp.md)
* [configure_replication_nat](configure_replication_nat.md)
* [configure_replication_private](configure_replication_private.md)
...
* [remove_floating_ips](remove_floating_ips.md)
* [update_proxy](update_proxy.md)
...
* [add_account_aws](add_account_aws.md)
* [delete_account_aws](delete_account_aws.md)
* [get_account_aws_native_id](get_account_aws_native_id.md)
* [get_accounts_aws](get_accounts_aws.md)
* [get_accounts_aws_detail](get_accounts_aws_detail.md)
* [get_accounts_azure](get_accounts_azure.md)
* [get_accounts_gcp](get_accounts_gcp.md)
* [get_instances_azure](get_instances_azure.md)
* [get_instances_ec2](get_instances_ec2.md)
* [get_instances_gce](get_instances_gce.md)
* [get_object_ids_azure](get_object_ids_azure.md)
* [get_object_ids_ec2](get_object_ids_ec2.md)
* [get_object_ids_gce](get_object_ids_gce.md)
* [get_sla_domains](get_sla_domains.md)
* [get_snapshots](get_snapshots.md)
* [get_task_status](get_task_status.md)
* [submit_assign_sla](submit_assign_sla.md)
* [submit_on_demand](submit_on_demand.md)
* [submit_restore_ec2](submit_restore_ec2.md)
...
* [get_sql_db_files](get_sql_db_files.md)
* [get_sql_live_mount](get_sql_live_mount.md)
* [get_vsphere_live_mount](get_vsphere_live_mount.md)
* [get_vsphere_live_mount_names](get_vsphere_live_mount_names.md)
* [get_vsphere_vm](get_vsphere_vm.md)
* [get_vsphere_vm_details](get_vsphere_vm_details.md)
* [get_vsphere_vm_file](get_vsphere_vm_file.md)
* [get_vsphere_vm_snapshot](get_vsphere_vm_snapshot.md)
...
* [sql_instant_recovery](sql_instant_recovery.md)
* [sql_live_mount](sql_live_mount.md)
* [sql_live_unmount](sql_live_unmount.md)
* [vcenter_refresh_vm](vcenter_refresh_vm.md)
* [vsphere_instant_recovery](vsphere_instant_recovery.md)
* [vsphere_live_mount](vsphere_live_mount.md)
* [vsphere_live_unmount](vsphere_live_unmount.md)

### Physical Host Functions

* [add_host_share](add_host_share.md)
* [add_nas_share_to_host](add_nas_share_to_host.md)
