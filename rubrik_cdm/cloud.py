...
class Cloud(_API):
    ...
    def aws_s3_cloudout(self, aws_bucket_name, archive_name='default', aws_region=None, aws_access_key=None, aws_secret_key=None, kms_master_key_id=None, rsa_key=None, storage_class='standard', timeout=30):
        ...
        # Create a new dictionary that includes only the values returned by archives_on_cluster
    ...
    def aws_native_account(self, aws_account_name, aws_access_key=None, aws_secret_key=None, aws_regions=None, regional_bolt_network_configs=None, timeout=30):
        ...
        if regional_bolt_network_configs is not None: 
            for bolt_network_config in regional_bolt_network_configs:
                ...
                elif any(requiredkey not in bolt_network_config for requiredkey in ['region','vNetId','subnetId','securityGroupId']):
