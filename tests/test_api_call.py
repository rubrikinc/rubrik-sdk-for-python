...
def test_get_call(rubrik_init):
    ...
    response_body = {'id': '89fc0e90-6f1c-8393-efas-90c7qee0e6299', 'version': '4.1.1', 'apiVersion': '1',
                     'name': 'RubrikAPICluster', 'timezone': {'timezone': 'America/Los_Angeles'}, 'acceptedEulaVersion': '1.0', 'latestEulaVersion': '1.0'}
